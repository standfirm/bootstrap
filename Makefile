...
build:
	...
	@node_modules/.bin/uglifyjs docs/assets/js/bootstrap.js -nc > docs/assets/js/bootstrap.min.tmp.js
...
bootstrap:
	...
	node_modules/.bin/uglifyjs bootstrap/js/bootstrap.js -nc > bootstrap/js/bootstrap.min.tmp.js
